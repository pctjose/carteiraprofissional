...
public class EnviarEmail {
	...
	public static void sendEmail(final String userFrom, final String userFromPass,String recepientEmail, String title,
			String sms, String sourceAttacheFile) throws Exception {
		Properties props = new Properties();
		props.put("mail.smtp.starttls.enable", "true");
		props.put("mail.smtp.auth", "true");
		...
		Session session = Session.getInstance(props,
				new javax.mail.Authenticator() {
					protected PasswordAuthentication getPasswordAuthentication() {
						return new PasswordAuthentication(userFrom, userFromPass);
					}
				});
