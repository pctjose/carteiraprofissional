...
public class ListaCategoriaProfissionalVM {
	...
	public void onAddNew(){
		...
		Window cRequisicao = (Window) Executions.createComponents(
				"/pages/admin/parametrizacao/CategoriaProfissional.zul", null, null);
	...
	public void onDelete(@BindingParam("userRecord") final Categoria categoria) {		
		Messagebox.show("Tem que pretende apagar a categoria profissional: "+categoria.getDesignacao()+"?",
		    ...
		    public void onEvent(Event evt) throws InterruptedException {
		        if (evt.getName().equals("onOK")) {
		        	...
		        	dataSet = categoriaService.getAllCategorias();
		        	Clients.showNotification("Categoria profissional: "+categoria.getDesignacao()+" apagada com sucesso");
		        }
		    }
		});
